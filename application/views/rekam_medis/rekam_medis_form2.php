		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
						...
						<div class="panel-body">
							...
							<div class="panel-body">
								<table class="table">
									...
									<tr><td>Tanggal Lahir</td><td id="tgl_lhr"></td></tr>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="modal-body">
											<table data-toggle="table" data-url="<?php echo base_url('rekam_medis/data_laporan_rekam_medis_detail/'.$id_pasien);?>" 
			...
			<form action="<?php echo base_url('rekam_medis/simpan_rekam_medis/'.$ID_pasien.'/'.$id_rekam_medis);?>" method="post">
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1234">
  Data Obat
									...
									<br />
									<br />
									<div class="col-xs-12"><button type="submit" class="btn btn-danger pull-right" id="cetak">Selesai dan Simpan</button></div>
									<br />
									<br />
									<br />
								</div>
...
<div class="modal fade" id="myModal_tambah_stok_obat<?php echo $noq1; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form action="<?php echo base_url('obat'); ?>/simpan_stok_obat_dokter/<?php echo $key->id.'/'.$id_pasien ?>" method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal_edit_obat<?php echo $noq1 ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo base_url('obat'); ?>/simpan_edit_dokter/<?php echo $id_pasien.'/'.$key->id; ?>" method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal_tambah_tambah_obat_dokter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form action="<?php echo base_url('obat'); ?>/simpan_tambah_dokter/<?php echo $id_pasien ?>" method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal_tamabah_layanan_dokter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form action="<?php echo base_url(); ?>/layanan/create_action_dokter/<?php echo $id_pasien; ?>" method="post">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Layanan</h4>
      </div>
...
<script type="text/javascript">
	...
	function action_layanan_dokter(row, value, index){
		...
		data+='<a href="<?php echo base_url('layanan/delete_dokter/'.$id_pasien); ?>/'+value.id_layanan+'" onclick="return confirm(\'Apakah anda yakin akan menghapus layanan ini?\')" class="btn btn-danger">Hapus</a>';
		return data;
	}
...
<div class="modal" id="myModal_edit_layanan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
       <form action="<?php echo base_url('layanan/update_action_dokter/'.$id_pasien); ?>" method="post">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
