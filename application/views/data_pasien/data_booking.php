						...
						<div class="tab-content col-md-8">
								...
								<form action="<?php echo base_url('Booking/create_action/'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="col-lg-8">
										<div class="form-group box2">
											...
											<select class="form-control" name="jam_rencana" id="jam_rencana" style="width: 480px;">
									...
									<button data-toggle="tab" href="#data_diri" type="button" class="btn salmon stil1" style="float: right; margin-top:5%; margin-right:20px;">Selanjutnya</button>
							</div>
							<div id="data_diri" class="tab-pane fade">
								...
								<div id="data_diri1">
									...
									<?php foreach ($pasien->result() as $result) : ?>
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="tempat_lahir" id="tempat_lahir" style="width:225px" required>
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="jenis_kelamin" id="jenis_kelamin" style="width: 225px;" required>
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="status_nikah" id="status_nikah" style="width: 225px;" required>
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="pekerjaan" id="pekerjaan" style="width: 225px;" required>
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="pendidikan" id="pendidikan" style="width: 225px;">
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="jenis_id" id="jenis_id" style="width: 225px;">
										...
										<div class="col-lg-4">
											<div class="form-group">
												<input type="number" class="form-control" rows="3" name="no_id" id="no_id" value="<?php echo $result->no_id; ?>">
											</div>
										</div>
										<button data-toggle="tab" href="#pilih_jadwal" type="button" class="btn salmon" style="float: left; margin-top: 20%; margin-left:20px;">Kembali</button>
										<button onclick="next1()" type="button" class="btn salmon" style="float: right; margin-top: 20%; margin-right:20px;">Selanjutnya</button>
								</div>
								<div id="data_diri2" hidden>
									...
									<div class="col-lg-3">
										<div class="form-group box2">
											<select class="form-control" name="kota_kab" id="kota_kab" style="width: 165px;" required>
									...
									<div class="col-lg-3">
										<div class="form-group box2">
											<select class="form-control" name="provinsi" id="provinsi" style="width: 165px;" required>
									...
									<div class="col-lg-3">
										<div class="form-group box2">
											<select class="form-control" name="gol_darah" id="gol_darah" style="width: 165px;" required>
								...
								<button onclick="prev2()" type="button" class="btn salmon" style="float: left;  margin-top: 13%; margin-left:20px">Kembali</button>
								<button onclick="next2()" type="button" class="btn salmon" style="float: right;  margin-top: 13%; margin-right:20px">Selanjutnya</button>
								</div>
								<div id="data_diri3" hidden>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="tempat_lahir_dekat" id="tempat_lahir_dekat" style="width: 225px;" required>
												<option value="Malang" id="Malang">Malang</option>
												<option value="Surabaya" id="Surabaya">Surabaya</option>
												<option value="Semarang" id="Semarang">Semarang</option>
												<option value="Medan" id="Medan">Medan</option>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="jenis_kelamin_dekat" id="jenis_kelamin_dekat" style="width: 225px;" required>
												<option value="Laki-Laki" id="Laki-Laki">Laki-Laki</option>
												<option value="Perempuan" id="Perempuan">Perempuan</option>
											</select>
										</div>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="hubungan_dekat" id="hubungan_dekat" style="width: 225px;" required>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="jenis_id_dekat" id="jenis_id_dekat" style="width: 225px;" required>
												<option value="KTP" id="KTP">KTP</option>
												<option value="SIM" id="SIM">SIM</option>
												<option value="Paspor" id="Paspor">Paspor</option>
											</select>
									...
									<div class="col-lg-4">
										<div class="form-group">
											<input type="number" class="form-control" rows="3" name="no_id_dekat" id="no_id_dekat" required>
										</div>
									</div>
									...
									<div class="col-lg-3">
										<div class="form-group box2">
											<select class="form-control" name="kota_kab_dekat" id="kota_kab_dekat" style="width: 165px;" required>
												<option value="Malang" id="Malang">Malang</option>
												<option value="Surabaya" id="Surabaya">Surabaya</option>
												<option value="Semarang" id="Semarang">Semarang</option>
												<option value="Medan" id="Medan">Medan</option>
									...
									<div class="col-lg-3">
										<div class="form-group box2">
											<select class="form-control" name="provinsi_dekat" id="provinsi_dekat" style="width: 165px;" required>
												<option value="Jawa Timur" id="Jawa Timur">Jawa Timur</option>
												<option value="Jawa Barat" id="Jawa Barat">Jawa Barat</option>
												<option value="Jawa Tengah" id="Jawa Tengah">Jawa Tengah</option>
												<option value="Sumatera Utara" id="Sumatera Utara">Sumatera Utara</option>
									...
									<div class="col-lg-4">
										<div class="form-group">
											<input type="number" class="form-control" rows="3" name="no_hp_dekat" id="no_hp_dekat" required>
										</div>
									</div>

									<button onclick="prev3()" type="button" class="btn salmon" style="float: left; margin-top: 1%; margin-left:20px">Kembali</button>
									<button onclick="next3()" type="button" class="btn salmon" style="float: right; margin-top: 1%; margin-right:20px">Selanjutnya</button>
								</div>
								<div id="data_diri4" hidden>
									...
									<div class="col-lg-6">
										<div class="form-group box2" required>
											<select class="form-control" name="kunjungan" id="kunjungan" style="width: 355px;">
									...
									<div class="col-lg-6">
										<div class="form-group box2">
											<select class="form-control" name="market" id="market" style="width: 355px;" required>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="form-group box2">
												<select class="form-control" name="komunikasi" id="komunikasi" style="width: 355px;" required>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="form-group box2">
												<select class="form-control" name="informasi_update" id="informasi_update" style="width: 355px;" required>
									...
									<button onclick="prev4()" type="button" class="btn salmon" style="float: left;  margin-top: 25%; margin-left:20px">Kembali</button>
									<button data-toggle="tab" href="#keluhan" type="button" class="btn salmon stil2" style="float: right;margin-top: 25%; margin-right:20px">Selanjutnya</button>
								</div>
							...
							<div id="keluhan" class="tab-pane fade">
								...
								<div class="col-lg-12">
									...
									<button data-toggle="tab" href="#data_diri" type="button" class="btn salmon stil2" style="float: left;margin-top: 17%; margin-left:20px">Kembali</button>
									<button data-toggle="tab" href="#metode_pembayaran" type="button" class="btn salmon stil3" style="float: right;margin-top: 17%; margin-right:20px">Selanjutnya</button>
								</div>
							</div>
							<div id="metode_pembayaran" class="tab-pane fade">
								...
								<div class="col-lg-4">
									<div class="form-group box2">
										<select class="form-control" name="jenis_pembayaran" id="jenis_pembayaran" style="width: 225px;" required>
								...
								<div id="asuransiku" hidden>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="provider" id="provider" style="width: 225px;" hidden />
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											<select class="form-control" name="kasuransi" id="kasuransi" style="width: 225px;" hidden />
