								...
								<tbody>
									<?php foreach ($bayar->result() as $result): ?>
										...
										<tr>
											...
											<td><a href="<?php echo base_url() ?>owner/metode_bayar/<?php echo $result->id_booking ?>/<?php echo $result->id_rekam_medis ?>" type="button" class="btn btn-success col-md-12"  style="text-align: center; color: white; background-color: #00b050; border-radius: 0px;"> Proses Bayar </a></td>
										</tr>
									<?php endforeach; ?>
								</tbody>
							</table>
