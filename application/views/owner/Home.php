                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li>
                      <div class="form-group" style="">
                        <center><button class="btn btn-anim btn-white" style="width: 200px; border-radius: 5px" type="button" onclick="location.href ='<?php echo base_url('owner/tambah_pasien'); ?>'"><span class="btn-text">Buat Akun Keluarga</span></button></center>
              ...
              <div class="nav-collapse">
                <form action="<?php echo base_url('owner/add_booking'); ?>" method="post">
                  ...
                  <?php endforeach; ?>
                    ...
                    <li class="button"> <a href="#" class="button" data-toggle="modal" data-target="#ModalTolak"><b>Pilih Cabang</b><br><br>
                        <font color=" #90a4ae">
