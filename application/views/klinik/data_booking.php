						...
						<div class="tab-content col-md-8">
							...
							<div id="konfirmasi_booking" class="tab-pane fade in active">
								...
								<div class="row col-lg-5 mt-f">
									<a href="<?php echo base_url('klinik/'); ?>" class="btn salmon stil2" data-formatter="lanjut" style="margin: 250px 0 0 0; float: right; background-color:#f40049; color:white" data-align="center">Kembali ke Beranda</a>
								</div>
							</div>
						</div>
					</div>
