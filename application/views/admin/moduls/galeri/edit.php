...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditgaleri" action="<?= base_url('C_galeri/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_galeri" value="<?= $data->id_galeri ?>">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Edit Galeri</h3>
            </div>
...
<script>
    ...
    $('#formEditgaleri').submit(function(e) {
        e.preventDefault();
        tinyMCE.triggerSave();
