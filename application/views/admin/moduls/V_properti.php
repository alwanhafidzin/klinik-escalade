...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Properti</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Properti</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" name="foto_properti" id="input_foto5" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Nama Properti</label>
                                    <input type="text" class="form-control" name="nama_properti" placeholder="Nama Properti" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Deskripsi Properti</label>
                                    <textarea class="form-control" name="deskripsi_properti" id="input_deskripsi" placeholder="Deskripsi Properti"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->foto_properti) { ?>
                                    <img src="<?= base_url('assets/img/' . $value->foto_properti) ?>" width="100">
                                <?php } ?>
                            </td>
                            <td><?= $value->nama_properti ?></td>                            
                            <td><?= $value->deskripsi_properti ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_properti ?>')">
                                    <i class="fa fa-edit"> Edit</i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_properti ?>')">
