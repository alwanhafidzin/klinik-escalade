            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="nama_depan" placeholder="Nama Depan" value="<?= $data->nama_depan ?>" required>
                    </div>

                    <div class="col-md-12">
                        <label>Nama Belakang</label>
                        <input type="text" class="form-control" name="nama_belakang" placeholder="Nama Belakang" value="<?= $data->nama_belakang ?>" required>
                    </div>                    
