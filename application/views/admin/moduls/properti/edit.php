...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditPengalaman" action="<?= base_url('C_properti/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_properti" value="<?= $data->id_properti ?>">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Edit Properti</h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" name="foto_properti" id="edit_input_foto5">
                    </div>

                    <div class="col-md-12">
                        <label>Nama Properti</label>
                        <input type="text" class="form-control" name="nama_properti" placeholder="Nama Properti" value="<?= $data->nama_properti ?>" required>
                    </div>              
                    
                    <div class="col-md-12">
                        <label>Deskripsi Properti</label>
                        <textarea class="form-control" name="deskripsi_properti" id="edit_input_deskripsi" placeholder="Deskripsi Properti"><?= $data->deskripsi_properti ?></textarea>
                    </div>
                </div>
            </div>
