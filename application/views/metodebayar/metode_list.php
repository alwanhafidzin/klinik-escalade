	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Daftar Metode Pembayaran</h1>
            </div>
        </div><!--/.row-->
        ...
        <div id="toolbar" class="btn-group">
                <a href="<?=base_url('metodebayar/create')?>" type="button" class="btn btn-primary">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Metode Bayar
                </a>
            </div>

        <table id="all_data_json" data-toggle="table"
                   data-url="<?=base_url()?>metodebayar/get_json_metode"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="nama_metode" data-sortable="true">Metode Pembayaran</th>
                   
                        <th data-field="id_metode" data-formatter="action_metode" data-align="center">Action</th>
                    </tr>
                </thead>
        </table>
...
<script>
    function action_metode(value) {
        var url='<?=base_url('metodebayar/') ?>';
