      ...
      <div class="glider-contain multipled" style="margin-left: 18px; margin-top: 5%">
        ...
        <div class="dots">
          <figure class="figure-2">
            <blockquote class="blockquote-2">Escalade - Tebet</blockquote>
            <p>
              Jl Tebet Dalam no 10
              Jakarta Selatan
              (021) 728762
            </p>
            <a href="" class="btn btn-primary" style="background-color: #e48a9e; border: none; width: 10em">
              Temukan kami di<br>Google Maps
            </a>
          </figure>
          <figure class="figure-2">
            <blockquote class="blockquote-2">Escalade – Radio Dalam</blockquote>
            <p>
              Jl Radio Dalam Tengah no 1
              Jakarta Selatan
              (021) 814762
            </p>
            <a href="#" class="btn btn-primary" style="background-color: #e48a9e; border: none; width: 10em">
          ...
          <figure class="figure-2">
            <blockquote class="blockquote-2">Escalade – Rawamangun</blockquote>
            <p>
              Jl Rawamangun Raya no 10
              Jakarta Pusat
              (021) 714562
            </p>
            <a href="#" class="btn btn-primary" style="background-color: #e48a9e; border: none; width: 10em">
          ...
          <figure class="figure-2">
            <blockquote class="blockquote-2">Blossom</blockquote>
            <p>
              asdad
            </p>
            <a href="#" class="btn btn-primary" style="background-color: #e48a9e; border: none; width: 10em">
          ...
          <figure class="figure-2">
            <blockquote class="blockquote-2">Buttercup</blockquote>
            <p>
              adasda
            </p>
            <a href="#" class="btn btn-primary" style="background-color: #e48a9e; border: none; width: 10em;">
