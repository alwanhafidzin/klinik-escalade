						...
						<div class="tab-content col-md-8">
							<div id="pilih_jadwal" class="tab-pane fade in active">
								<form action="<?php echo base_url('Booking/create_action/'); ?>" method="post" enctype="multipart/form-data">
									...
									<button data-toggle="tab" href="#data_diri" type="button" class="btn salmon" style="float: right;margin-top: 37%;">Selanjutnya</button>
							</div>
							<div id="data_diri" class="tab-pane fade">
								...
								<div id="data_diri1">
									...
									<?php foreach ($pasien->result() as $result) : ?>
										...
										<button data-toggle="tab" href="#pilih_jadwal" type="button" class="btn salmon" style="float: left; margin-top: 20%;">Kembali</button>
