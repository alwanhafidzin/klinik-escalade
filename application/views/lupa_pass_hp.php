...
<body>
  <div class="container">
    ...
    <div id="login-form">
     <?php echo form_open('Login/kirim_nohp');?>
     <br>
     <br>
     <div class="wow"> 
      <div class="te">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" name="no_hp" value="<?php echo set_value('no_hp'); ?>" class="form-control" placeholder="Masukkan No. Handphone" maxlength="40" required="required"/>
        </div>
      </div>
      ...
      <div class="form-group">
        <button type="submit" class="btn btn-block btn-primary">Ubah Kata Sandi</button>
      </div>
      <div class="form-group">
        <a href="<?php echo base_url() ?>Login/lupa/">Kembali</a>
      </div>
