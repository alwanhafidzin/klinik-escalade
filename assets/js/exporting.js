(function ()
{
    var n = Highcharts,
        ...
        s = document,
        G = window,
        C = s.documentElement.ontouchstart !== undefined,
        y = n.getOptions();
    r(y.lang, {
    ...
    r(A.prototype, {
            ...
            q(["xAxis", "yAxis"], function (i)
            {
                q(c[i], function (g, o)
                {
                    var l = a[i][o],
                        ...
                        p = m.userMin;
                    m = m.userMax;
                    if (p !== void 0 || m !== void 0) l.setExtremes(p, m, true, false)
                })
            });
        ...
        contextMenu: function (b, c, a, f, d, k)
        {
            ...
            if (a + e.exportMenuWidth > i) b.right = i - a - d - m + "px";
            else b.left = a - m + "px";
            if (f + k + e.exportMenuHeight > g) b.bottom = g - f - m + "px";
            else b.top = f + k - m + "px";
            u(l, b)
        },
        addButton: function (b)
        {
            ...
            var a = this,
                f = a.renderer,
                d = x(a.options.navigation.buttonOptions, b),
                k = d.onclick,
                e = d.menuItems,
                j = d.width,
                h = d.height,
