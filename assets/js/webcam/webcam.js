...
var site = "/" + pathArray[1] + "/mcinew/assets/administrator/";
var webcam_files = pathArray[0] + "/mcinew/assets/administrator/";
//alert (window.location);  
//var webcam_files = (location.host.match(/([^.]+)\.\w{2,3}(?:\.\w{2})?$/) || [])[1]+ "/assets/administrator/";
window.webcam = {
  version: '1.0.9',
  ...
  swf_url: webcam_files+'components/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
  shutter_url: webcam_files+'components/webcam/shutter.mp3', // URI to shutter.mp3 sound
  api_url: 'a', // URL to upload script
